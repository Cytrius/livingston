...
<style>
    ...
    .select2 { min-width:251px; }
    .small .select2 { min-width:180px; }
...
<div class="lg-section-holder section-1" style="border-bottom:none;">

         <p class="lg-section-heading marginx2">What vehicle would you like to transport</p>

                <div class="section-3-2">

                    <div class="row">
                        <div class="row-item small" style="display:block; float:left">
                        ...
                        <div class="row-item" style="display:block; float:left">
                            <div class="lg-subsection-holder" style="opacity: 1;">
                                ...
                                <div id="pd_country" style="height:auto;position: relative; top: -2px;">
                                    <!--<select id="cb_vehicleType" name="cb_vehicleType"></select>-->
                                    <select name="cb_vehicleType" id="cb_vehicleType" style="width:250px; background-color:#fff;">
                                        <option value=""></option>
                ...
                <div class="lg-section-content">
                    <div class="checkbox-group">
                        ...
                        <label for="vehicleCanBeDriven">The vehicle can be driven</label>
                    </div>
                </div>
                <br/>
                ...
                <div class="lg-section-content">
                    <div class="checkbox-group">
                        ...
                        <label for="vehicleHasParkingBreak">The vehicle has a functioning parking break</label>
                    </div>
                </div>
                <br/>
                ...
                <div class="lg-section-content">
                    <div class="checkbox-group">
                        ...
                        <label for="vehicleEmpty">The vehicle contains no personal effects</label>
                    </div>
                </div>
                <br/>
            ...
            <div class="lg-section-holder section-3">

                <p class="lg-section-heading marginx2">When do you need the vehicle moved?</p>
            ...
            <div class="lg-section-holder section-2">
                ...
                <div class="lg-section-content">
                    ...
                    <div class="checkbox-group">
                        <input class="radio" id="cb_pickupRequired" name="cb_pickupRequired" type="checkbox" value="yes">
                        <label class="radio" for="cb_pickupRequired">Yes, I need the shipment picked up.</label>
                    </div>
                    <br/>
                    <div class="checkbox-group">
                        <input class="radio" id="cb_pickupNoRequired" name="cb_pickupNoRequired" type="checkbox" value="yes">
                        <label class="radio" for="cb_pickupNoRequired">No, I will drop off the shipment at the terminal.</label>
                    </div>
                ...
                <div class="section-2-2">
                    ...
                    <div class="lg-section-content">
                        <div class="checkbox-group">
                            <input class="radio" id="cb_deliveryRequired" name="cb_deliveryRequired" type="checkbox" value="yes">
                            <label class="radio" for="cb_deliveryRequired">Yes, I need the shipment delivered.</label>
                        </div>
                        <br/>
                        <div class="checkbox-group">
                            <input class="radio" id="cb_deliveryNoRequired" name="cb_deliveryNoRequired" type="checkbox" value="yes">
                            <label class="radio" for="cb_deliveryNoRequired">No, I will pick up the shipment at the terminal.</label>
                        </div>
                        <br/>
                        <div class="marginx3 hidden" style="height: 72px;">
                            <div class="lg-subsection-holder" style="opacity: 1;">
